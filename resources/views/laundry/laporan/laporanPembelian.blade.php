    ...
    <div class="box box-primary" style="margin-top:3%;">
      ...
      <div class="box-body">
        <div class="form-group">
              <?php
                  echo Form::open(['url' => 'laporan/pembelian/', 'method' => 'post']);
                    echo csrf_field() ;

                    echo "<div class='form-group'>";
                      echo ' <input type="checkbox" name="cbNota" value="Bike">'; echo' <label>No Nota</label>  <select class="form-control select2" name="noNota" style="width: 100%;">';
                      foreach ($dataPembelian as $arr ){
                        echo '<option value="'. $arr->ID_BELI.'">'. $arr->ID_BELI.'</option>';
                      }echo '</select>';

                      echo ' <input type="checkbox" name="cbGudang" value="Bike">'; echo' <label>Gudang Tujuan</label> ';
                      ...
                      echo ' <input type="checkbox" name="cbSupplier" value="Bike">'; echo' <label>Supplier</label>  <select class="form-control select2" name="idSupplier" style="width: 100%;">';
